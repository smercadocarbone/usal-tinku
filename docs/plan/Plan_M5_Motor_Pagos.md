...
3. Llama a la API de MercadoPago para liberar la porción correspondiente al Tutor (split ya definido en la preferencia original, no es una segunda transacción).
