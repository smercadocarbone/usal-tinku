...
- [x] **Chunk UX-TYC + FOTO** — Puntos clave de los Términos en el registro (T-UX-TYC, FR-ID-030) y foto obligatoria del Tutor (T-ID-FOTO, FR-ID-028) — _branch `claude/lucid-lovelace-htlv4z`, 2026-09-25._
