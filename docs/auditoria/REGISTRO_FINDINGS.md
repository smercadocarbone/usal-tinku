...
| AUD-018 | ALTA | Modo Bypass deja el marketplace gratis sin TTL ni alerta | CERRADO | 2 | (este commit) — FASE2-07, P2 (a), ADR-M5-01 actualizado | `PasarelaServiceBypassTest` (3) |
