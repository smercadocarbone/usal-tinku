...
| AUD-007 | CRÍTICA | No hay endpoint para ver el archivo de la Credencial Académica | CERRADO | 1 | (este commit) | `AdminPanelIntegracionTest.aud007_*` (3), `AlmacenamientoLocalTest` (5), `IdentidadFlujosIntegracionTest.aud007_*` (2) |
