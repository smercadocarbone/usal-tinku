...
| AUD-014 | ALTA | No existe infraestructura real de notificaciones | CERRADO | 2 | (este commit) — FASE2-03: outbox `admin.notificaciones` (V32) = bandeja in-app + email por Resend (ADR-000-06); reset de contraseña por email | `KillswitchIntegracionTest.killswitchMenor_*` (2), `NotificacionesIntegracionTest` (3), `EnvioEmailNotificacionesIntegracionTest` (6), `NotificadorResetPasswordEmailTest` (4) |
