...
/**
 * Acceso a {@code matching.perfiles_tutor_matching} vía JdbcTemplate + arrays
 * nativos de PostgreSQL (contrato 2a): la columna {@code tema_ids UUID[]} no
 * tiene mapeo JPA de primera clase, así que leer/escribir el array con
 * {@code PGConnection.createArrayOf("uuid", ...)} / native query es el camino
 ...
 */
@Repository
public class PerfilTutorMatchingRepository {

    private final JdbcTemplate jdbc;

    public PerfilTutorMatchingRepository(JdbcTemplate jdbc) {
        this.jdbc = jdbc;
    }
