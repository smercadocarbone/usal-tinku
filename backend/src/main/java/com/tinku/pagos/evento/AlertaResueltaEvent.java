 ...
 * {@code pausado_denuncia}; con este evento M5 reembolsa el total al Estudiante,
 * sea cual sea la decisión ({@code reactivar} o {@code sancionar}). Payload mínimo
 * (reservaId), mismo patrón que {@link DenunciaRegistradaEvent}.
 */
